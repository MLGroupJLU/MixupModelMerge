...
MODEL_LIST = {
    ...
    MergedModel_Math: ['/root/autodl-tmp/save_merge_models/save_merge_models/math_code_lam_0.923556_nodare_withmixup_average_merging/math/average_merging',
                       '/root/autodl-tmp/save_merge_models/save_merge_models/math_code_nodare_nomixup_average_merging/math/average_merging'
                        ],
}
MODEL_LIST_VLM = {
...
class LLMModel(object):
    ...
    def _create_model(self, max_new_tokens, temperature, device, dtype, model_dir, system_prompt, api_key, **kwargs):
        ...
        if model_class:
            ...
            elif model_class == MergedModel_Math:
                #调用MergedModel_Math类
                return model_class(self.model_name, max_new_tokens, temperature, device)
            else:
